...
System.out.println("Character after receiving 15 damage - Health: "
+ character.getHealth());
swordsman.receiveDamage(30);
System.out.println("Swordsman after receiving 30 damage - Health: "
+ swordsman.getHealth());
paladin.receiveDamage(40);
System.out.println("Paladin after receiving 40 damage - Health: " +
paladin.getHealth());
break;
...
paladin.getHealth());
paladin.resurrect();
System.out.println("Paladin after resurrecting - Health: " +
paladin.getHealth());
